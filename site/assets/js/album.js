...
(function(){
  ...
  const renderMasonry = () => { const m=el('div','masonry'); M.photos.forEach(p=>m.append(figure(p))); document.getElementById('masonry').replaceChildren(m); };
  ...
  renderTimeline(); renderMasonry(); renderFavorites(); renderBonus();
