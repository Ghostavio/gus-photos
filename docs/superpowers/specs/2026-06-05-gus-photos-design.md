...
- **Prereqs (done):** repo public, Discussions enabled, giscus app installed, the Announcements category in use.
...
- **giscus category is "Announcements"** (recommended Announcement-type), not a dedicated "Comments" category.
